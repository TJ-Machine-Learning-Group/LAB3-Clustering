...
from DataPrepare.dataAnalyzeandPrepare import GetData
...
if __name__ == "__main__":
    ...
    models = dict()
    #初始化模型，要调参可以在这里调
    models['kmeans'] = KMeans(n_clusters=5, random_state=random_state)
    models['dbscan'] = DBSCAN(eps=0.1, min_samples=10)
    data = GetData("./Live_20210128.csv")
